...
//$_POST['team_tag']=str_replace(["'","\"","`","/","\\"],' ', $_POST["team_tag"]);
    ...
    $check= "select leader_username, member_one_username, member_two_username from team where leader_username ='".$_POST['leader_username']."' 
    or member_one_username ='".$_POST['leader_username']."' 
    or member_two_username ='".$_POST['leader_username']."' 
    ;";
   ...
   foreach ($conn->query  ($check) as $row){
    ...
    $sql= "select username from candidat where username ='".$_POST['leader_username']."' and state = 1;'";
 foreach ($conn->query  ($sql) as $row){
    ...
    $s4="";
    $sql2= "select username from candidat where username ='".$_POST['leader_username']."';'";
