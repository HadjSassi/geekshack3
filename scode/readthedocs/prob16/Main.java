...
class Main {
    ...
    public static void main(String[] args)
    {
        ...
        String nB=sc.nextLine(); //black pieces
        String nW = sc.nextLine();
        String Kp = sc.nextLine();
        int Nbb =(int) (nB.charAt(2)-'0');
        int Nww = (int) (nW.charAt(2)-'0');
        int attacker;

        if(Kp.charAt(0)=='0'){
            board[(int)(Kp.charAt(2)-'0')-1][(int)(Kp.charAt(4)-'0')-1]='K';
            Nbb--;
            attacker = 1;
        }
        else{
        ...
        for(int k=0;k<Nbb+Nww;k++){
            String string = sc.nextLine();
            if((int)string.charAt(0)==attacker){
                if(attacker ==0){
                    board[(int)(string.charAt(2)-'0')-1][(int)(string.charAt(4)-'0')-1]=string.charAt(6);
                }
                else {
                    board[(int)(string.charAt(2)-'0')-1][(int)(string.charAt(4)-'0')-1]=Character.toUpperCase(string.charAt(6));
                }
            }
        }
