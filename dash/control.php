    ...
    <div class="sidebar-brand">
        <table>
            <tr>
                ...
                <td><h2 onclick="window.location.href='/'"
                        style="cursor:pointer;margin-top: 7px; margin-left: 2px; color: white;">Geeks Club</h2></td>
            </tr>
        ...
        <ul>
            ...
            <li>
                ...
                <span style="cursor: pointer"
                      onclick="window.location.href='control_candidates.php'">Control Candidates</span>
            </li>
            <li>
                <span class="las la-users"></span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table width="120%" id="myTable" data-filter-control="true"
                                ...
                                <tbody>
                                <?php
                                // Function to compare problem numbers numerically
                                function compareProblemNumbers($a, $b) {
                                    $numericA = intval(preg_replace('/[^\d]/', '', $a['problemNumber']));
                                    $numericB = intval(preg_replace('/[^\d]/', '', $b['problemNumber']));
                                    return $numericA - $numericB;
                                }

                                // Sort the problemsData array using the custom comparison function
                                usort($problemsData, 'compareProblemNumbers');
                                        ...
                                        <td>
                                            <?php if ($_SESSION['role'] === 'admin') { ?>
                                                <button class="btn btn-primary" style="margin-right: 3%;"
                                                        onclick="copyProblemFolder('<?php echo $problem['problemNumber']; ?>')">
                                                    Add
                                                </button>
                                                <button class="btn btn-danger" style=""
                                                        onclick="deleteProblemFolder('<?php echo $problem['problemNumber']; ?>')">
                                                    Revoke
                                                </button>
                                            <?php } else { ?>
                                                <!-- Display a message or a disabled button for non-admin users -->
                                                <button class="btn btn-primary disabled" style="margin-right: 3%;">Add
                                                </button>
