...
// session_start();
if ($timestamp_today < $timestamp_start) {
    ...
    <div class="limiter">
        <div class="container-login100" style="background: transparent;">
            ...
            <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55"
                 style="opacity:95%;background-image:linear-gradient(115deg,#25304e 1%,#010c24);">
                <form class="login100-form validate-form flex-sb flex-w" method="POST">
                    ...
                    <div class="container-login100-form-btn">
                        <button id="btn" class="login100-form-btn"
                                style="background-image:linear-gradient(115deg,#25304e 1%,#010c24); box-shadow:2px 2px 5px #000000;">
                            Login
                        </button>
                    </div>
