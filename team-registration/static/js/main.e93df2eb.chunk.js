            ...
            return Object(n.useEffect)(Object(u.a)(o.a.mark((function e() {
                ...
                return o.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, g.a.get("http://https://geekshack.ensitgeeksclub.com//number.php");
                        case 2:
                    ...
                    children: [Object(f.jsx)("img", {src: j}), Object(f.jsxs)(O.a, {
                        ...
                        onSubmit: function (e) {
                            if (e.preventDefault(), r(!0), "" !== Z && "" !== et && m) {
                                var t = new FormData;
                                t.append("team_tag", Z), t.append("leader_username", et), t.append("member_one_username", _e), t.append("member_two_username", Me), t.append("preuve", m), g.a.post("http://https://geekshack.ensitgeeksclub.com//paiement.php", t).then((function (e) {
                                ...
                                children: [Object(f.jsx)("input", {
                                    ...
                                    onChange: function (e) {
                                        !function (e) {
                                            if (/[^a-zA-Z0-9_]/.test(e.target.value)) $("Team tag must contain letters and numbers only !!"), ne("red"); else if (5 <= e.target.value.length && e.target.value.length <= 15) {
                                                G(e.target.value);
                                                var t = new FormData;
                                                t.append("team_tag", e.target.value), g.a.post("http://https://geekshack.ensitgeeksclub.com//teamname.php", t).then((function (e) {
                                    ...
                                    onChange: function (e) {
                                        !function (e) {
                                            tt(e.target.value);
                                            var t = new FormData;
                                            t.append("leader_username", e.target.value), g.a.post("http://https://geekshack.ensitgeeksclub.com//leader.php", t).then((function (e) {
                                            ...
                                            onChange: function (e) {
                                                !function (e) {
                                                    if ("" != e.target.value) if (Fe(e.target.value), e.target.value == Me) de("Don't use the same username twice"), ut("red"), Ge(!0), we(0); else if (e.target.value != et) {
                                                        var t = new FormData;
                                                        t.append("username", e.target.value), g.a.post("http://https://geekshack.ensitgeeksclub.com//member.php", t).then((function (e) {
