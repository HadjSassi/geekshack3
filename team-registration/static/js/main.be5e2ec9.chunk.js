        ...
        var m = function () {
            ...
            return Object(n.useEffect)((function () {
                ...
                className: "screen", children: Object(O.jsxs)("div", {
                    className: "container",
                    children: [Object(O.jsx)("img", {src: u}), Object(O.jsxs)(b.a, {
                        isOpen: S,
                        ...
                        onSubmit: function (e) {
                            ...
                            children: [Object(O.jsxs)("div", {
                                ...
                                children: [Object(O.jsxs)("h2", {
                                    ...
                                    children: ["You have only ", ht, " to upload your request"]
                                })]
                            }), Object(O.jsxs)("div", {
                                hidden: Re[0],
                                children: [Object(O.jsx)("input", {
                                    ...
                                    style: {color: ee, paddingLeft: "1em"},
                                    children: V
                                }), Object(O.jsx)("input", {
                                    className: "input-group.input-group-icon",
                                    type: "text",
                                    ...
                                    style: {color: at, paddingLeft: "1em"},
                                    children: Ke
                                }), Object(O.jsx)("input", {
                                    type: "button",
                                    value: "Next",
                                ...
                                children: [Object(O.jsx)("label", {
                                                ...
                                                !function (e) {
                                                    if ("" != e.target.value) if (Te(e.target.value), e.target.value == Le) ue("Don't use the same username twice"), ot("red"), Ue(!0), ve(0); else if (e.target.value != Xe) {
                                                        ...
                                                        t.append("username", e.target.value), h.a.post("https://geekshack.ensitgeeksclub.com/member.php", t).then((function (e) {
                                                            r(!1), 200 == e.status && (me(!1), ue(e.data), ot("green"), Ue(!1), ve(20)), e.status >= 201 && (ue(e.data), me(!0), ot("red"), Ue(!0), ve(0))
                                                        })).catch((function (e) {
                                    ...
                                    style: {color: rt, paddingLeft: "1em"},
                                    children: ie
                                }), Object(O.jsx)("label", {
                                    className: "doc",
                                    style: {padding: "0", margin: "1%", marginTop: "0", display: "flex"},
                                            ...
                                            onChange: function (e) {
                                                !function (e) {
                                                    if ("" != e.target.value) if (e.target.value == De) se("Don't use the same username twice"), dt("red"), Ue(!0), ke(0); else if (e.target.value != Xe) {
                                                        ...
                                                        var t = new FormData;
                                                        t.append("username", e.target.value), h.a.post("https://geekshack.ensitgeeksclub.com/member.php", t).then((function (e) {
                                                            r(!1), 200 == e.status && (se(e.data), dt("green"), Ue(!1), ke(20)), e.status >= 201 && (se(e.data), dt("red"), Ue(!0), ke(0))
                                                        })).catch((function (e) {
                                    ...
                                    style: {color: lt, paddingLeft: "1em"},
                                    children: ce
                                }), Object(O.jsxs)("div", {
                                    className: "btc",
